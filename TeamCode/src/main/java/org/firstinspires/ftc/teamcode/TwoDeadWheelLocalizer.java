...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -4178.966396715585; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4278.954438636402; // x position of the perpendicular encoder (in tick units)
    }
